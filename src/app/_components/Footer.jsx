    ...
    return (
        <main className="flex flex-col mt-20">
            <div className="bg-white flex flex-col md:flex-row justify-between items-start py-4 px-10 gap-10">
                <div className="text-center w-full md:w-1/4 flex flex-col gap-6 md:gap-10">
                    <h1 className="text-4xl">Incubated By</h1>
                    <p>
                        MaDeIT Innovation Foundation, 3rd floor Laboratory complex, IIITDM Kancheepuram, Melakkottiyur, Kandigai, Chennai, Tamilnadu, pin-600127.
                        Clean Energy International Incubation Centre, TATA Power - DDL, Smart Grid lab, Sector 15, Rohini, New Delhi - 110085.
                    </p>
                </div>
                <div className="text-center w-full md:w-1/3 flex flex-col gap-6 md:gap-10">
                    <h1 className="text-4xl">Address</h1>
                    <p>
                        306 J J Nagar Iyyangarkulam-Kancheepuram,<br /> Tamil Nadu 631502
                    </p>
                </div>
                <div className="text-center w-full md:w-1/5 flex flex-col gap-6 md:gap-10">
                    <h1 className="text-4xl">Contact Us</h1>
                    <p className="flex flex-row gap-4 text-2xl items-center justify-center text-center">
